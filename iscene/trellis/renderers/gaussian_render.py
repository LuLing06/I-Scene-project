...
class GaussianRenderer:
    ...
    def __init__(self, rendering_options={}) -> None:
        ...
        self.rendering_options = edict({
            "resolution": None,  # square resolution (legacy). If None, use width/height.
            "width": None,
            "height": None,
            "near": None,
            "far": None,
    ...
    def render(
        ...
        width_opt = self.rendering_options.get("width", None)
        height_opt = self.rendering_options.get("height", None)
        ...
        # Determine target image size (before SSAA downsample)
        if width_opt is not None and height_opt is not None:
            target_w = int(width_opt)
            target_h = int(height_opt)
        else:
            # Fallback to square
        ...
        camera_dict = edict({
            "image_height": target_h * ssaa,
            "image_width": target_w * ssaa,
            "FoVx": fovx,
            "FoVy": fovy,
            "znear": near,
            "zfar": far,
